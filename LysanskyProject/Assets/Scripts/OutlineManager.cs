...
{
    public GameObject targetObject; // Объект, вокруг которого будут включаться выделения (например, игрок)
    public float radius = 10f; // Радиус вокруг объекта
    public KeyCode activationKey = KeyCode.E; // Клавиша для активации выделений
